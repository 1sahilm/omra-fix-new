          ...
          <div className={Styles.feature_Box}>
            <div className="col-md-12">
              ...
              <p className={Styles.center_align3}>
                Track, Automate & Maximize Your Team’s Productivity with our CRM
                Software
              </p>
              <h2>
                We believe in building industry-first solutions that best-fit
                your process
              </h2>
            ...
            <div className="col-md-6">
              <div className="valuecontent1" style={{ marginLeft: "-178p" }}>
                ...
                <p style={{ padding: "0" }}>
                  ...
                  files, updates, notes, etc. You can collaborate & work with
                  your whole team in closure the deal effectively. The CRM
                  stands to Manage Leads & Deals, Time Tracking, Grow and
                  Automate, Dashboard and Report, Privacy and Security,
                  Customize your CRM and you can manage your contacts through
                  one solution.
                </p>
              </div>
            </div>
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              ...
              <p>
                ...
                leads, sales forecasting, and so on by leveraging our CRM sales
                force automation.
              </p>
            </div>
            <div className="col-md-4">
            ...
            <div className="col-md-4">
              ...
              <p>
                {`Track your leads' from contacting to convert by getting
                practical sales performance reports and the CRM boost your sales
