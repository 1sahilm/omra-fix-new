      ...
      <>
            ...
            <div className="row">
              <div className={Styles.feature_Box}>
                <div className="col-md-12">
                  ...
                  <h2>
                    E-Laundry Solution -Easy to access Technology woth complete
                    Trackablity
                  </h2>
              ...
              <div className="col-md-5">
                <div className="valuecontent1" style={{ marginLeft: "-178p" }}>
                  ...
                  <p style={{ padding: "0" }}>
                    ...
                    Complete accessibility in a Single click from anywhere
                    anytime to get proper Business Reporting. The Complete Order
                    tracking and connectivity of all Laundry and Dry-Clean
                    Models like Brand Owner or Admin Access, Super Admin for
                    Franchise, Store Billing, Connected Customer Mobile App and
                    Web Platform, Rider Mobile App for Order Pickup and
                    Delivery, Factory and Factory/Warehouse Management.
                  </p>
        ...
        <section className={Styles.mydiv88}>
          <div className="container">
            ...
            <p className={Styles.paddingSide}>
              A tradition of quality cleaning, fast order with fast delivery,
              automate your billings with tagging on garments, separately! Stay
              ahead from the problems with our complete business management
              solutions. Best laundry POS for your business.
            </p>
              ...
              <div className="col-md-7">
                <div className="" style={{ marginLeft: "-178p" }}>
                  ...
                  <p style={{ padding: "0" }}>
                    ...
                    business. So, let’s take your business on autopilot with
                    complete solutions & customer management.
                  </p>
                </div>
              </div>
              <div className="col-md-5">
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-6">
                ...
                <p style={{ padding: "0" }}>
                  Provided better customer experience through digital payments
                  and communicating with your customers via SMS Or E-mail
                  notification. We will make them feel special by recording
                  their preferences even when you’re not around.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className={Styles.mydiv88}>
          <div className="container">
            ...
            <p className={Styles.paddingSide}>
              ...
              Take advantage of multi-store features to accelerate your
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="" style={{ marginLeft: "-178p" }}>
                  ...
                  <br />
                  <p style={{ padding: "0" }}>
                    You will have the option to link database between multi
                    stores which can Allow you to quickly update prices across
                    stores and make sure your stores have details of every
                    customer.
                  </p>
                </div>
              </div>
        ...
        <section className={Styles.mydiv88}>
          <div className="container">
            ...
            <h4 className={Styles.titile_box}>
              Let start your laundry business in a smart way, not in an Ordinary
              way !
            </h4>
          </div>
        </section>
            ...
            <div className="row">
              <div className="col-md-7">
                <div className="" style={{ marginLeft: "-178p" }}>
                  ...
                  <p style={{ padding: "0" }}>
                    Send promotional notifications, offers professional services
                    to achieve customer’s trust and enjoy more referrals, make
                    evidence-based business decisions which are integrated with
                    latest echnology and customer can experience latest digital
                    services.
                  </p>
                </div>
              </div>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-6">
                <br /> <br />
                <h1 className={Styles.valuecontent1}>
                  Implement the Industry’s best practices in the process to make
                  your business smoother
                </h1>
                <p style={{ padding: "0" }}>
                  E-laundry helps you to streamline your business and implement
                  industry standard proven techniques to maximize revenue and
                  minimize stress for you. All you have to do is, Try E-Laundry
                  and take your business to higher level.
                </p>
              </div>
            </div>
          </div>
