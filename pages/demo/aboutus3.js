            ...
            <div className="row">
              ...
              <div className="col-sm-6">
                <div className={Styles.section1}>
                  ...
                  <p className={Styles.para}>
                    We are enabling business transformation that can be agile,
                    intuitive and transparent to stay competitive through our
                    radical solutions. We are global leader to outsource in B2B
                    & B2C sales.
                  </p>
                </div>
              </div>
