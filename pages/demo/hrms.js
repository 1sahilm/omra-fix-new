          ...
          <div className={Styles.feature_Box}>
            <div className="col-md-12">
              ...
              <p>
                ...
                simplifies human interactions, delivers actionable insights to
                build better workplaces and achieve their strategic HR goals
                faster and smarter.
              </p>
              ...
              <p className={Styles.parea}>
                ...
                system, giving you more time to focus on what’s important - your
                company’s growth and your employees’ wellbeing. We are focusing
                on automating their payroll, staying in sync with every law, and
                delighting their employees.
              </p>
            ...
            <div className="col-md-5">
              <div className="valuecontent1" style={{ marginLeft: "-178p" }}>
                ...
                <p className={Styles.multi_para33}>
                  60+ YC and Surge startups use OMRA to simplify their payroll.
                  Here's why
                </p>
              </div>
            </div>
            ...
            <div className="col-md-6">
              <div className="valuecontent1" style={{ marginLeft: "-178p" }}>
                <p className={Styles.paraimg}>
                  On-time Periodic upgrade and evolution,ideal integrations with
                  our
                </p>
                ...
                <p style={{ padding: "0" }}>
                  ...
                  workplace is not easy as it seems and we’re here to help. With
                  our HRMS you will have a complete foundation to digitally
                  transform the manual work. What's more? We have our own team
                  to make editing in your software, giving you access to
                  training tools & learning materials to help your company for
                  becoming smart organization with the smart work procedure.
                </p>
              </div>
            </div>
            <div className="col-md-6">
