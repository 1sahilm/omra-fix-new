              ...
              <div className="row">
                ...
                >
                  <div
                    className={`${
                      open === "p1"
                        ? "pricingtable-wrapper style-2 m-b30 active"
                        : "pricingtable-wrapper style-2 m-b30"
                    }`}
                  ...
                  >
                    <div className="pricingtable-inner">
                      ...
                      <div className="pricingtable-footer">
                        <Link href="#">
                          <a className="btn btn-primary gradient shadow rounded-xl">
                            Start Now
                          </a>
                        </Link>
                      </div>
                  ...
                  >
                    <div className="pricingtable-inner">
                      ...
                      <div className="pricingtable-price">
                        <h2 className="pricingtable-bx">
                          $149
                          <small className="pricingtable-type">/Month</small>
                        </h2>
                      </div>
                      <ul className="pricingtable-features">
                        <li>Graphic Design </li>
